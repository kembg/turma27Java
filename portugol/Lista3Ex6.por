...
Ex.: o usuário entra 7, o programa vai mostrar 28, pois  1+2+3+4+5+6+7=28.*/
	...
	funcao inicio()
	{
		inteiro numero=0, somaNumeros=0, numerosAntes=0
		...
		faca{
			...
			numerosAntes++
			somaNumeros+=numerosAntes
			
		}enquanto(numerosAntes<numero)
		escreva("A soma dos valores anteriores ao numero digitado é : ", somaNumeros)
