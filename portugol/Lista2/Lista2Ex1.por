...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	funcao inicio()
	{
		...
		inteiro P, E
		real M
		escreva("Deu quantos quilos de tomate hoje, João? ")
		leia(P)
		...
		se(P-50 > 0){
			...
			escreva (E, " quilos a mais do que os permitidos, a multa será de ", M, " reais.")
		} senao {
			E = 0
			M = 0
			escreva ( "Excesso aos quilos permitidos : ", E, " a multa será de, ", M, " reais. ")
		} 
	}
}
/* $$$ Portugol Studio $$$ 
